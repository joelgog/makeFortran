...
def replace_all_patterns(lst):
    patternlist = [['SMP', 'm', 'e',], ['SMP', 'm', 'tau'], ['^'], ['Momentum'], ['Alpha'], ['Re', 'X', 'ScalarC0IR6', 's', 'me', 'me'], ['Im', 'X', 'DiscB', 's', 'me', 'me'], ['Eps', 'p2', 'q1', 'q2', 'sp1'], ['Eps', 'p2', 'q1', 'q2', 'sp2'], ['Eps', 'p2', 'q1', 'q2', 'sq1'], ['Eps', 'p2', 'q1', 'q2', 'sq2'],
                  ...
                  ['Im', 'X', 'ScalarC0', 's', 'me', '**', '2', 'me', '**', '2', '0', '0', 'me'], ['Re', 'X', 'ScalarC0', 's', 'mt', '**', '2', 'mt', '**', '2', '0', '0', 'mt'], ['Im', 'X', 'ScalarC0', 's', 'mt', '**', '2', 'mt', '**', '2', '0', '0', 'mt'], ['PaXKallenLambda', '-', 'ss', '-', 'tt', '+', '2', '*', 'me', '**', '2', '+', '2', '*', 'mt', '**', '2', 'me', '**', '2', 'mt', '**', '2',],['PaXKallenLambda', 'me', '**', '2', 'mt', '**', '2', '-', 'ss', '-', 'tt', '+', '2', '*', 'me', '**', '2', '+', '2', '*', 'mt', '**', '2'], ['s'], ['t']]
